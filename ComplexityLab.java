...
public class ComplexityLab {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Results for 5000 elements");
        System.out.println("Sort Type   Data Struct    Operations      Run Time(ms)");
        System.out.println("-------------------------------------------------------");
        start = System.currentTimeMillis();
        operations = mergeSortArray(array1); //uses a temorary array to combine halves
        end = System.currentTimeMillis();
        elapsedTime = end - start;
        System.out.printf("%-12s %-15s %-17d %-12d%n", "Merge", "Array",operations, elapsedTime);


        start = System.currentTimeMillis();
        operations = mergeSortList(list1); //just liks nodes better
        end = System.currentTimeMillis();
        elapsedTime = end - start;
        System.out.printf("%-12s %-15s %-17d %-12d%n", "Merge", "List",operations, elapsedTime);


        start = System.currentTimeMillis();
        operations = quickSortArray(array2,0,array2.length - 1, 0); //better
        end = System.currentTimeMillis();
        elapsedTime = end - start;
        System.out.printf("%-12s %-15s %-17d %-12d%n", "Quick", "array", operations, elapsedTime);


        start = System.currentTimeMillis();
        operations = quickSortList(list2);
        end = System.currentTimeMillis();
        elapsedTime = end - start;
        System.out.printf("%-12s %-15s %-17d %-12d%n", "Quick", "List",operations, elapsedTime);

        start = System.currentTimeMillis();
        operations = insertionSortArray(array3);//smaller left larger right
        end = System.currentTimeMillis();
        elapsedTime = end - start;
        System.out.printf("%-12s %-15s %-17d %-12d%n", "Insertion", "Array",operations, elapsedTime);

        start = System.currentTimeMillis();
        operations = insertionSortList(list3);//
        end = System.currentTimeMillis();
        elapsedTime = end - start;
        System.out.printf("%-12s %-15s %-17d %-12d%n", "Insertion", "List",operations, elapsedTime);

        start = System.currentTimeMillis();
        operations = selectionSortArray(array4);
        end = System.currentTimeMillis();
        elapsedTime = end - start;
        System.out.printf("%-12s %-15s %-17d %-12d%n", "Selection", "Array",operations, elapsedTime);


        start = System.currentTimeMillis();
        operations = selectionSortList(list4);
        end = System.currentTimeMillis();
        elapsedTime = end - start;
        System.out.printf("%-12s %-15s %-17d %-12d%n", "Selection", "List",operations, elapsedTime);

        numOfElements = 10000;

        array1 = new int[numOfElements];
        array2 = new int[numOfElements];
        array3 = new int[numOfElements];
        array4 = new int[numOfElements];
        ...
        System.out.println("");
        System.out.println("Results for 10000 elements");
        System.out.println("Sort Type   Data Struct    Operations      Run Time(ms)");
        System.out.println("-------------------------------------------------------");
        start = System.currentTimeMillis();
        operations = mergeSortArray(array1); //uses a temorary array to combine halves
        ...
        System.out.println("");
        System.out.println("Results for 50000 elements");
        System.out.println("Sort Type   Data Struct    Operations      Run Time(ms)");
        System.out.println("-------------------------------------------------------");
        start = System.currentTimeMillis();
        operations = mergeSortArray(array1); //uses a temorary array to combine halves
        ...
        System.out.println("");
        System.out.println("Results for 100000 elements");
        System.out.println("Sort Type   Data Struct    Operations      Run Time(ms)");
        System.out.println("-------------------------------------------------------");
        start = System.currentTimeMillis();
        operations = mergeSortArray(array1); //uses a temorary array to combine halves
